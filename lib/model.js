...
class Model {
  ...
  static findById(param, options) {
    ...
    if (typeof param === 'number' || typeof param === 'string' || Buffer.isBuffer(param)) {
      ...
      for (const attribute of this.primaryKeyAttributes) {
        if (param[attribute] === undefined) {
          throw new Error('Argument passed to findById missing primary key field' + param);
        }
        options.where[attribute] = param[attribute];
      }
    } else {
